...
export type CompleteMagicLinkResponse = Message<"public.auth.v1.CompleteMagicLinkResponse"> & {
   ...
   *
   * @generated from field: repeated string joined_org_ids = 3;
   */
  joinedOrgIds: string[];
};
...
/**
 * SSORequired is the error detail of SSO_REQUIRED: accounts on the domain sign in
 * only through SSO.
 *
 * @generated from message public.auth.v1.SSORequired
 */
export type SSORequired = Message<"public.auth.v1.SSORequired"> & {
  /**
   ...
   *
   * @generated from field: bool invite = 3;
   */
  invite: boolean;
};

/**
 * Describes the message public.auth.v1.SSORequired.
 * Use `create(SSORequiredSchema)` to create a new message.
 */
export const SSORequiredSchema: GenMessage<SSORequired> = /*@__PURE__*/
...
export type CompleteOIDCSignInResponse = Message<"public.auth.v1.CompleteOIDCSignInResponse"> & {
  ...
  /**
   * Orgs this sign-in added the account to, by invite or by auto-join on a
   * verified domain.
   *
   * @generated from field: repeated string joined_org_ids = 3;
   */
