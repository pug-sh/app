...
const fieldVariants = cva('group/field flex w-full gap-2 data-[invalid=true]:text-negative', {
  variants: {
    orientation: {
...
function FieldError({
  ...
  return (
    <div role="alert" data-slot="field-error" className={cn('text-sm font-normal text-negative', className)} {...props}>
      {content}
    </div>
  )
}
